...
export const KindaMediumPotato = ({ style }: Props) => {
    return (
        <svg
            width="219"
            height="239"
        ...
        >
            <path
                ...
                fill="url(#paint0_linear_KindaMedium)"
                stroke="black"
                stroke-width="3"
            />
            <g clip-path="url(#clip0_KindaMedium)">
                <path
