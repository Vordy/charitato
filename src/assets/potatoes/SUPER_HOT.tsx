...
export const SuperHotPotato = ({ style }: Props) => {
    return (
        <svg
            width="219"
            height="239"
        ...
        >
            ...
            <defs>
                ...
                >
                    <stop offset="0.0153453" stopColor="#FFDE67" />
                    <stop offset="1" stopColor="#FFF6D7" />
                </linearGradient>
